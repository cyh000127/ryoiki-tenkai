...
v3는 v2의 blocked 항목을 해제하지 않고, 현재 구현을 반복 검증과 인수인계가 쉬운 형태로 묶는 범위로 시작합니다.
...
- v3 제외: concrete frame recognizer runtime 선택, skill/resource 구현, 승인되지 않은 asset 또는 provider copy.
