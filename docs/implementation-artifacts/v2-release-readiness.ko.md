...
| V2-E2 Persistence and Runtime Operation Readiness | partial | storage adapter 전환, migration smoke, failure policy는 완료, audit retention 문서가 남아 있음 |
...
1. `V2-E2-ST04`: compact audit retention boundary 문서화.
2. `V2-E1-ST03`: no-hand, unstable-hand, recognized-token 상태 분리.
3. `V2-E1-ST04`: recognizer restart, cleanup, permission recovery hardening.
